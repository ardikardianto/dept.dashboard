...
function Plotting({ lecturers, setLecturers, courses }) {
  ...
  const rows = lecturers.filter((lecturer) => [lecturer.id, lecturer.name, lecturer.email, lecturer.expertise.join(" "), lecturer.plotted.join(" "), plottedCourseTitles(lecturer, courses).join(" ")].some((value) => includes(value, query)));
